...
const TARGETS = [
  ...
  {
    src: "client/public/assets/images/about-family.jpg",
    widths: [800, 1200],
    formats: ["jpg", "webp", "avif"],
    namePrefix: "about-family",
    outDir: "client/public/assets/images",
  },
  {
    src: "client/public/assets/images/about-arsenal.jpg",
    widths: [800, 1200],
    formats: ["jpg", "webp", "avif"],
    namePrefix: "about-arsenal",
    outDir: "client/public/assets/images",
  },
  {
    src: "client/public/assets/images/now-life.jpg",
    widths: [800, 1200],
    formats: ["jpg", "webp", "avif"],
    namePrefix: "now-life",
    outDir: "client/public/assets/images",
  ...
  {
    src: "client/public/assets/images/piper.jpg",
    widths: [400, 800],
    formats: ["jpg", "webp", "avif"],
    namePrefix: "piper",
    outDir: "client/public/assets/images",
